    ...
    <footer className="bg-black/95 pt-10">
      <div className="py-3">
        <div className="flex flex-col justify-center items-center w-full mx-auto">
          <Image src={"/logo.webp"} alt="logo imase" width={100} height={100} />
        </div>
        <nav className="flex flex-col sm:flex-row justify-center items-center gap-5 sm:gap-x-20 my-4 md:my-10 md:mb-0 text-lg">
          {FooterData.map((item) => (
            <Link
              key={item.id}
              href={item.href}
      ...
      <div className="py-0 md:py-5">
        <div className="w-full">
          <div className="flex justify-center items-center gap-10 md:my-5 w-full">
            <svg
